...
@Api(value = "按年和月分库分表DDL", tags = {"按年和月分库分表"}, consumes = MediaType.APPLICATION_JSON_VALUE)
public class ShardingYearnMonthDDLController {

    @Autowired
    private DataSource dataSource;

    public static final String DROP_TABLE_SQL = "DROP TABLE IF EXISTS `sharding_year_month`;";

    public static final String TRUNCATE_TABLE_SQL = "TRUNCATE TABLE `sharding_year_month`;";

    public static final String CREATE_TABLE_SQL =
            "CREATE TABLE `sharding_year_month`  (\n" +
